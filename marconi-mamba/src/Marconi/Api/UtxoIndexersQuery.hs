...
import Marconi.Api.Types (DBConfig (DBConfig, utxoConn),
                          ...
                          HasDBQueryEnv (dbConf, queryAddresses, queryComm), HasUtxoQueryComm (indexer),
                          QueryExceptions (AddressNotInListError, QueryError), TargetAddresses,
                          UtxoQueryComm (UtxoQueryComm), UtxoTxOutReport (UtxoTxOutReport))
